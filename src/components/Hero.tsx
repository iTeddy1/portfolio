      ...
      <section id="home" className="relative flex flex-col items-center justify-center">
        <div className="mx-auto mt-32 flex flex-col items-start">
          ...
          <div className="mt-8 flex items-center space-x-3">
            ...
            <a className="size-6" href="https://github.com/iTeddy1" target="_blank">
            ...
            <a className="size-6" href="https://www.linkedin.com/in/duytrung-nguyen1/" target="_blank">
              <span className="fill-bgDark dark:fill-bgLight">
                <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        {/* <div className="absolute right-16">
          <img src="/src/assets/dalat2.jpg" className="w-64 mix-blend-multiply" alt="" />
        </div> */}
      </section>
    </>
  );
