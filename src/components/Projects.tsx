      ...
      <div className="mx-16">
        ...
        <div className="space-y-6">
          {projects.map((project, index) => (
            <div
              key={index}
              className="grid lg:grid-cols-2 grid-rows-1 gap-6 rounded-lg border-2 border-borders bg-container p-4 shadow-lg dark:border-borders-dark dark:bg-container-dark"
            >
              <div className="flex flex-col justify-center p-4">
                <h3 className="text-2xl font-bold">{project.title}</h3>
                <p className="md:text-sm text-xs w-3/4">{project.description}</p>
                ...
                {project.link &&  <a href={project.link} target="_blank" className="fill-bgDark dark:fill-bgLight">
                    <svg
                  ...
                  {project.githubLink && <a href={project.githubLink} target="_blank" className=" size-7 fill-bgDark dark:fill-bgLight">
